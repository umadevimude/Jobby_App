...
class Jobs extends Component {
  ...
  getJobs = async () => {
    ...
    const apiUrl = `https://apis.ccbp.in/jobs?employment_type=${employeeType.json()}&minimum_package=${minimumSalary}&search=${searchInput}`
  ...
  renderFailureView = () => (
    <div className="jobs-error-views-container">
      <img
