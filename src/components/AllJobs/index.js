...
class AllJobs extends Component {
  ...
  onGetJobsFailureView = () => (
    <div className="failure-button-container">
      <img className="failure-img" src={failureViewing} alt="failure view" />
      ...
      {employmentTypesList.map(eachItem => (
        <li className="li-container" key={eachItem.employmentTypeId}>
          <input
            ...
            type="checkbox"
            onChanange={this.onGetInputOption}
          />
      ...
      {salaryRangesList.map(eachItem => (
        <li className="li-container" key={eachItem.salaryRangeId}>
          <input
            ...
            type="radio"
            name="option"
            onChanange={this.onGetRadioOptions}
          />
          ...
          <div className="jobs-container">
            <div>
              <input
                ...
                value={searchInput}
                placeholder="Search"
                onChanange={this.onGetSearchInput}
