...
class AboutJobItem extends Component {
    ...
    if (jobDataDetails.length >= 1) {
      ...
      return (
        <>
          <div className="job-item-container">
            ...
            <div className="second-part-container">
              <div className="description-visit-container">
                ...
                <a className="vidsit-anchor" href={companyWebsiteUrl}>
          ...
          <h1 className="similar-jobs-headng">Similar Jobs</h1>
  ...
  renderJobFailureView = () => (
    <div className="job-details-failure-view">
      ...
      <div className="btn-container-failur">
        <button
  ...
  renderJobLoadingView = () => (
    <div className="job-details-loader" data-test-id="loader">
      <Loader type="TheeDots" color="#4f46e5" height="50" width="50" />
    </div>
  )
  ...
  render() {
    return (
      <>
        <Header />
        <div className="jod-details-view-container">
